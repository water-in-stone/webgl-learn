...
import vertexShaderSource from "../shaders/transformation/3d-camera/vertex-2d.glsl";
import fragmentShaderSource from "../shaders/transformation/3d-camera/fragment-2d.glsl";
...
export default class App {
    ...
    render() {
        ...
        const drawScene = () => {
            ...
            // the camera is
            var cameraMatrix = this.m4.yRotation(cameraAngleRadians);
            cameraMatrix = this.m4.translate(cameraMatrix, 0, 0, radius * 1.5);
            ...
            var cameraMatrix: number[] = this.m4.lookAt(cameraPosition, fPosition, up);
    ...
    setGeometry(gl) {
        ...
        for (var ii = 0; ii < positions.length; ii += 3) {
            var vector = this.m4.vectorMultiply([positions[ii + 0], positions[ii + 1], positions[ii + 2], 1], matrix);
